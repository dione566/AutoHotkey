...
WheelUp::
    if (MacroActive) {
        ToolTip, 🚫 Macro (AimBot Sniper) Ativo. Desative-o primeiro., A_ScreenWidth/2, A_ScreenHeight/2
    ...
    if (ColorAimbotActive) {
        ...
        ToolTip, ✅ AimBot Tiro LIGADO, A_ScreenWidth/2, A_ScreenHeight/2
...
z::
    ...
    ToolTip, 🛑 MACROS DESATIVADOS, A_ScreenWidth/2, A_ScreenHeight/2
    SoundBeep, 200, 200
