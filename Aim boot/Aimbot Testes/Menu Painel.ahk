...
Gui, Add, Checkbox, x20 y110 vCheck3 gRodar3, Ativar HEADSHOT
Gui, Add, Checkbox, x20 y140 vCheck4 gRodar4, Mira_03
Gui, Add, Checkbox, x20 y170 vCheck5 gRodar5, Delta Force_v4

; --- INFORMAÇÕES ADICIONAIS ---
Gui, Font, s8 cYellow
Gui, Add, Text, x20 y195 w199 +Center, [ F11 ] FECHAR JOGOS
Gui, Font, s8 cLime ; Verde claro para o comando de minimizar
Gui, Add, Text, x20 y210 w199 +Center, [ F12 ] MINIMIZAR JANELA ATIVA
Gui, Font, s10 cWhite

; Botão movido para baixo para dar espaço aos avisos
Gui, Add, Button, x20 y235 w199 h35 gSair, FECHAR TODOS E SAIR
...
Fechar3:
WinClose, %A_ScriptDir%\Head Shoot.ahk - AutoHotkey
return
