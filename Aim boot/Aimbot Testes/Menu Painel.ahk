...
; --- Atalho de Limpeza Total (F12) ---
F12::
    ; 1. Minimiza todas as janelas abertas
    ; Isso simula o comando Win + D ou o clique no canto da barra de tarefas
    ComObjCreate("Shell.Application").MinimizeAll
    
    ; 2. Exibe uma confirmação visual rápida
    ToolTip, Área de Trabalho Ativa, 0, 0
    
    ; Programa a remoção do ToolTip após 2 segundos
    SetTimer, RemoverToolTip, 2000
return
