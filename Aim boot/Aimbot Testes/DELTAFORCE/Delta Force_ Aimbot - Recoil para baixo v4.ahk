...
ToolTip, Minimizar - DeltaForce (F12), 0, 0
return

; --- Atalho Minimizar - DeltaForce (F12) ---
F12::
    ...
    ; 2. Tentar focar na janela do DeltaForce
    if WinExist("ahk_exe DeltaForce")
    {
        WinActivate, ahk_exe DeltaForce.exe
