...
ColorToFind := "ff0000,fd081D,fb0a2a"
Variation := 0
...
ToolTip, ✅ Script ATIVO! (F7 Pausa | X Visualiza | Alt+Setas Move | Z Sair), A_ScreenWidth/2, A_ScreenHeight/2
...
~F7::
    if (Paused) {
        ...
        SetTimer, VisualizerUpdate, 50
        Paused := False
        ToolTip, ✅ Script ATIVO! (F7 Pausa), A_ScreenWidth/2, A_ScreenHeight/2
        ...
        Paused := True
        ToolTip, 🛑 Script PAUSADO! (F7 Ativa), A_ScreenWidth/2, A_ScreenHeight/2
        SetTimer, RemoveToolTip, -2000
    }
    return
