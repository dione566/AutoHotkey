...
~LButton::
    ...
    while GetKeyState("LButton", "P")
    {
        ...
        ; Força de puxada para baixo (mude o '3' se precisar puxar mais ou menos)
        ForcaRecuo := 3
        
        ; Move o mouse para baixo usando o método DLL (mais rápido e seguro)
        DllCall("mouse_event", "UInt", 0x0001, "Int", 0, "Int", ForcaRecuo, "UInt", 0, "UPtr", 0)
        
        ; Delay em milissegundos entre cada puxada
        Sleep, 12
    }
return