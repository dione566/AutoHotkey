...
ColorToFind   := 0xB31890   ; Cor exata do centro do círculo no seu Paint
...
WheelUp::
    ...
    AtualizarMenu()
    SetTimer, MainLoop, 1
    SetTimer, PressionarG, 10000  ; <-- LIGA o timer do G (a cada 1 minuto)
return
...
WheelDown::
    ...
    SetTimer, PressionarG, Off    ; <-- DESLIGA o timer do G imediatamente
return
...
; =======================================================================
PressionarG:
    ; Usando SendEvent com um "press duration" de 50ms para o jogo detectar o clique com certeza
    SetKeyDelay, 0, 50
    SendEvent, g
return