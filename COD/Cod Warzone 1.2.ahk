...
; === ATIVAÇÃO DO G (Colocado aqui no topo para funcionar com certeza) ===
SetTimer, PressionarG, 300
...
; =======================================================================
; --- Execução do Comando G ---
; =======================================================================

PressionarG:
    ; Se o jogo estiver em tela cheia exclusiva, o "Send" normal pode falhar.
    ; "SendPlay" ou "SendEvent" costumam ser mais compatíveis com jogos.
    SendEvent, g
return